  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Upworx4, a comprehensive platform where Owners, Recruiters and Freelancers seamlessly interact, manage job offers, applications and contracts to foster business growth."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1521791136064-7986c2920216?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZWNydWl0bWVudHxlbnwwfHx8fDE2OTk0MzI4NjZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Upworx4, a comprehensive platform where Owners, Recruiters and Freelancers seamlessly interact, manage job offers, applications and contracts to foster business growth.`}
            </Text>
            <Box
